...
am__v_CXXLD_1 = 
SOURCES = $(main_SOURCES) $(test_FuncA_SOURCES)
DIST_SOURCES = $(main_SOURCES) $(test_FuncA_SOURCES)
...
am__DIST_COMMON = $(srcdir)/Makefile.in COPYING INSTALL depcomp \
	install-sh missing
...
CXXFLAGS = -g -O2 -ffile-prefix-map=/home/daryna/labka=. -flto=auto -ffat-lto-objects -flto=auto -ffat-lto-objects -fstack-protector-strong -Wformat -Werror=format-security
CYGPATH_W = echo
DEFS = -DPACKAGE_NAME=\"main\" -DPACKAGE_TARNAME=\"main\" -DPACKAGE_VERSION=\"1.0\" -DPACKAGE_STRING=\"main\ 1.0\" -DPACKAGE_BUGREPORT=\"dasha.kondratez@gmail.com\" -DPACKAGE_URL=\"\" -DPACKAGE=\"main\" -DVERSION=\"1.0\"
DEPDIR = .deps
ECHO_C = 
ECHO_N = -n
ECHO_T = 
